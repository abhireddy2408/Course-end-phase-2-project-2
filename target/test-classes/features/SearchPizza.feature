...
Scenario Outline: Validate Pizzahut pizza order flow
	...
	And User goes to checkout page enters "<name>" "<mobile>" and "<email>"
	
Examples:
 	| URL|Location|name|mobile|email|
 	| https://www.pizzahut.co.in/|bangalore Palace|aa|9123456789|aa@gmail.com|